...
```bash
git clone https://github.com/krishna-patil19/NLU-BotTrainer.git
cd NLU-BotTrainer
````
...
## 👥 Authors
  ...
  - **Krishna Patil** - [@krishna-patil19](https://github.com/krishna-patil19)
...
For support, email kri.patil1906@gmail.com or open an issue in this repository.
